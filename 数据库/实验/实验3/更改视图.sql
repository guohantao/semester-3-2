alter view student_select_view as
select student.student_id , student.student_name , student.class_id, department.department_name, teacher_name, course_name,book_name, publish_company, student_course.credit, student_course.grade
